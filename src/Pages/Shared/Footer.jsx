        ...
        <footer className="mt-6">
            <div className="footer p-10  bg-neutral text-neutral-content">
                <div>
                    ...
                    <p className="text-center font-medium">Perfect Capture<br />Providing photography course since 2020</p>

                </div>
                <div>
                    <span className="footer-title">Company</span>
                    <Link to="/" className="link link-hover font-medium">Home</Link>
                    <Link className="link link-hover font-medium">Instructors</Link>
                    <Link className="link link-hover font-medium">Classes</Link>
                    <Link className="link link-hover font-medium">Dashboard</Link>
                </div>
                <div>
                ...
                <div>
                    <span className="footer-title">Let's Stay Connected</span>
            ...
            <footer className="footer footer-center p-4  bg-neutral text-neutral-content">
                <div>
                    <p>Copyright © 2023 - All right reserved by Perfect Capture</p>
                </div>
            </footer>
        </footer>
    );
