...
const Reviews = () => {
    ...
    useEffect(() => {
        fetch('https://photography-school-server-monira-jahan.vercel.app/reviews')
            .then(res => res.json())
            .then(data => {
                setReviews(data)
            })
            ...
            >
                {
                    reviews.map(review => <SwiperSlide
                        key={review._id}
                    >
                        <div className="card w-96 h-96 px-8 py-6  bg-sky-400 shadow-xl flex sm:flex-col items-center mx-24 my-16 transform transition duration-500 hover:scale-110 ">
